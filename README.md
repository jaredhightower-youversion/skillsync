...
<picture><source media="(prefers-color-scheme: dark)" srcset="https://www.shieldcn.dev/group/github/open-issues/jaredhightower-youversion/skillsync+github/open-prs/jaredhightower-youversion/skillsync+github/license/jaredhightower-youversion/skillsync.svg?variant=ghost&amp;size=sm&amp;mode=dark"><img alt="Open issues, open PRs, license" src="https://www.shieldcn.dev/group/github/open-issues/jaredhightower-youversion/skillsync+github/open-prs/jaredhightower-youversion/skillsync+github/license/jaredhightower-youversion/skillsync.svg?variant=ghost&amp;size=sm&amp;mode=light"></picture>
